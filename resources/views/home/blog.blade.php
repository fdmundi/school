        ...
        <div class="carousel-3items owl-carousel owl-theme mt-0">
            ...
            <div class="blog-box">
                ...
                <a href="blog-single.html">
                    <div class="image"><img src="{{asset('assets2/img/blog/blogstyle2-1.jpg')}}" alt=""/></div>
                </a>
                <!-- blog-box-caption -->
            ...
            <div class="blog-box">
                <!-- image -->
                <a href="blog-single.html">
                    <div class="image"><img src="{{asset('assets2/img/blog/blogstyle2-2.jpg')}}" alt=""/></div>
                </a>
                <!-- blog-box-caption -->
                <div class="blog-box-caption">
                    <!-- date -->
            ...
            <div class="blog-box">
                <!-- image -->
                <a href="blog-single.html">
                    <div class="image"><img src="{{asset('assets2/img/blog/blogstyle2-3.jpg')}}" alt=""/></div>
                </a>
                <!-- blog-box-caption -->
                <div class="blog-box-caption">
                    <!-- date -->
            ...
            <div class="blog-box">
                <!-- image -->
                <a href="blog-single.html">
                    <div class="image"><img src="{{asset('assets2/img/blog/blogstyle2-4.jpg')}}" alt=""/></div>
                </a>
                <!-- blog-box-caption -->
                <div class="blog-box-caption">
                    <!-- date -->
