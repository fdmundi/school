                ...
                <div class="card card-flip">
                    ...
                    <div class="card bg-secondary text-light ">
                        <div class="p-5">
                            ...
                            <a href="{{route('contact')}}" class="btn d-lg-none">Join Now</a>
                        </div>
                        <!-- /p-5 -->
                        <!-- image -->
                ...
                <div class="card card-flip ">
                    ...
                    <div class="card bg-primary text-light">
                        <div class="p-5">
                            ...
                            <!-- button show on mobile only,where flip is disabled -->
                            <a href="#!" class="btn d-lg-none">Start Now!</a>
                        </div>
                        <!-- /p-5 -->
                        <!-- image -->
                ...
                <div class="card card-flip ">
                    ...
                    <div class="card bg-tertiary text-light">
                        <div class="p-5">
                            ...
                            <!-- button show on mobile only,where flip is disabled -->
                            <a href="#!" class="btn d-lg-none">Start Learning</a>
                        </div>
                        <!-- /p-5 -->
                        <!-- image -->
                    ...
                    <div class="card bg-tertiary text-light card-back">
                        <div class="card-body d-flex justify-content-center align-items-center">
                            <div class="p-4">
                                ...
                                <p class="card-text">
                                    If your interest is in International Studies or Carer Paths, our center prepares you for the
                ...
                <div class="carousel-2items owl-carousel owl-theme col-md-12">
                    ...
                    <div class="testimonial">
                        ...
                        <div class="testimonial-review">
                            <h5 class="testimonial-title">Mr Mundi</h5>
                    ...
                    <div class="testimonial">
                        ...
                        <!-- /testimonial-pic -->
                        <div class="testimonial-review">
                            <h5 class="testimonial-title">Mrs Mundi A.</h5>
                    ...
                    <div class="testimonial">
                        ...
                        <!-- /testimonial-pic -->
                        <div class="testimonial-review">
                            <h5 class="testimonial-title">Mr Daniel</h5>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 bg-secondary p-5 justify-content-center align-self-center" data-start="left: 50%;"
                    ...
                    <div class="text-light justify-content-center align-self-center">
                        <h3>Enroll Today</h3>
                        <p>Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in
                            vulputate at, tempus vi tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate
